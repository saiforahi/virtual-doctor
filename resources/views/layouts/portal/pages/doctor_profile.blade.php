				...
				<div class="doctor-widget">
					...
					<div class="doc-info-right">
						...
						<div class="clinic-booking">
							<a class="apt-btn" href="{{route('book-appoinment',$doctor->id)}}">Book Appointment</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card-body pt-0">
				...
				<nav class="user-tabs mb-4">
					<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
						...
						<li class="nav-item">
							<a class="nav-link active" href="#doc_business_hours" data-toggle="tab">Business Hours</a>
						</li>
					</ul>
				</nav>
				<!-- /Tab Menu -->
				...
				<div class="tab-content pt-0">
					...
					<div role="tabpanel" id="doc_business_hours" class="tab-pane fade show active">
						<div class="row">
									...
									<div class="widget-content">
										<div class="listing-hours">
											<div class="listing-day current">
												<div class="day">Today <span>{{ date('d F Y') }}</span></div>
												<div class="time-items">
													<span class="open-status"><span @if(getOpenCloseDay($doctor->id, date('l'))=='Closed Now') class="badge bg-danger-light" @else class="badge bg-success-light" @endif>{{ getOpenCloseDay($doctor->id, date('l')) }}</span></span>
													<span class="time">{{ getDayName($doctor->id, date('l')) }}</span>
												</div>
											</div>
											<div class="listing-day">
												<div class="day">Monday</div>
												<div class="time-items">
													<span class="time">{{ getDayName($doctor->id,'Monday') }}</span>
												</div>
											</div>
											<div class="listing-day">
												<div class="day">Tuesday</div>
												<div class="time-items">
													<span class="time">{{ getDayName($doctor->id,'Tuesday') }}</span>
												</div>
											</div>
											<div class="listing-day">
												<div class="day">Wednesday</div>
												<div class="time-items">
													<span class="time">{{ getDayName($doctor->id,'Wednesday') }}</span>
												</div>
											</div>
											<div class="listing-day">
												<div class="day">Thursday</div>
												<div class="time-items">
													<span class="time">{{ getDayName($doctor->id,'Thursday') }}</span>
												</div>
											</div>
											<div class="listing-day">
												<div class="day">Friday</div>
												<div class="time-items">
													<span class="time">{{ getDayName($doctor->id,'Friday') }}</span>
												</div>
											</div>
											<div class="listing-day">
												<div class="day">Saturday</div>
												<div class="time-items">
													<span class="time">{{ getDayName($doctor->id,'Saturday') }}</span>
												</div>
											</div>
