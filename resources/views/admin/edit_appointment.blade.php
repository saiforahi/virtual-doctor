...
<div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="body">
                                            <form method="POST" action="{{ route('appointments.update',$appointment->id) }}" class="form-horizontal" enctype="multipart/form-data">
                                            	@csrf
                                                @method('PUT')
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <select class="form-control patient" name="patient_id" id="patient_id" required oninvalid="this.setCustomValidity('Please select a patient')"
    oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <select class="form-control doctor" onchange="doctorinfo()" name="doctor_id" id="doctor_id" required oninvalid="this.setCustomValidity('Please select a doctor')"
    oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <textarea style="border:1px solid gray" rows="5" name="patient_symptoms" class="form-control">{{ $appointment->patient_symptoms }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="date" onchange="doctorinfo()" id="visit_date" class="form-control" placeholder="" name="visit_date" value="{{ $appointment->visit_date }}" required  oninvalid="this.setCustomValidity('Please select a date')"
    oninput="this.setCustomValidity('')">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7" id="slotlist">
                                                        <div class="form-group">
                                                            <select class="form-control schedule" onkeyup="createSchedule()" onchange="createSchedule()" name="slot_id" id="slot_id" required oninvalid="this.setCustomValidity('Please select a time')"
    oninput="this.setCustomValidity('')">
                                                                <option value="create_schedule">Create Time Schedule</option>
                                                                @foreach($slot as $data)
                                                                    @if($appointment->schedule_id == $data->id)
                                                                        <option value="{{ $data->id }}" selected>{{ date('h:i:s A', strtotime($data->start_time)) }} - {{ date('h:i:s A', strtotime($data->end_time)) }}</option>
                                                                    @else
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <button type="button" class="btn btn-danger m-t-15 waves-effect">CANCEL</button>
                                                        ...
                                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect saveInfo">UPDATE</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
