...
<div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="body">
                                            <form method="POST" action="{{ route('reschedule_store') }}" class="form-horizontal" enctype="multipart/form-data">
                                            	@csrf
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <select class="form-control patient" name="doctor_id" id="doctor_id"  required oninvalid="this.setCustomValidity('Please select a doctor')"
    oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <select class="form-control patient" name="patient_type" id="patient_type" required oninvalid="this.setCustomValidity('Please select patient type')"
    oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input readonly="" type="text" id="investigation" class="form-control"  name="investigation" value="{{ $appointment->investigation }}" placeholder="investigation" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input readonly="" type="text" id="cc" class="form-control"  name="cc" value="{{ $appointment->cc }}" placeholder="cc" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input readonly="" type="text" id="diagonosis" class="form-control"  name="diagonosis" value="{{ $appointment->diagonosis }}" placeholder="diagonosis" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input readonly="" type="text" id="instructions" class="form-control"  name="instructions" value="{{ $appointment->instructions }}" placeholder="instructions" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input readonly="" type="text" id="prescribe_medicines" class="form-control"  name="prescribe_medicines" value="{{ $appointment->prescribe_medicines }}" placeholder="prescribe medicines" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input onchange="doctorinfo()" type="date" id="follow_up_visit_date" class="form-control" placeholder="" name="follow_up_visit_date" value="{{ $appointment->follow_up_visit_date }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row clearfix schedulTime" style="display: none;">
                                                    ...
                                                    <div class="col-lg-5 col-md-5 col-sm-4 col-xs-3">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                               <input type="Time" id="start_time" class="form-control" onchange="timeCheck()" name="start_time" value="" data-toggle="tooltip" data-placement="top" title="Start Time" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-5 col-md-5 col-sm-4 col-xs-3">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                               <input type="time" id="end_time" class="form-control" name="end_time" value=""  onchange="lastTimeCheck()" onkeyup="lastTimeCheck()" onclick="lastTimeCheck()" data-toggle="tooltip" data-placement="top" title="Minimum time difference should be 15 minutes.">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <button type="button" class="btn btn-danger m-t-15 waves-effect">CANCEL</button>
                                                        ...
                                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect saveInfo">SUBMIT</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
<script type="text/javascript">
    ...
    function doctorinfo(){
        ...
        // alert(doc_id);
        targetUrl='/teleassist-amarlab/set_appointment/'+appointId+'/doctor_slot/'+doc_id+'/'+follow_up_visit_date;
