...
@section('content')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist" id="useredit_tab">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="body">
                                            <form method="POST" action="{{ route('users.update', $user_info->id) }}"
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input @if(!auth() ->user()
                                                                ->hasRole('super-admin')) readonly @endif type="text"
                                                                id="email_address_2" class="form-control" placeholder="Enter
                                                        ...
                                                        <div class="form-group">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-new thumbnail">
                                                                    <img id="blah"
                                                                        src=" @if(is_null($user_info->image)) {{ url('storage/app/public/default.png') }} @else {{ url('storage/app/public/profile/' . $user_info->image) }} @endif  "
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input @if(!auth() ->user()
                                                        ->hasRole('super-admin')) readonly @endif type="text"
                                                        class="form-control" name="phone" value="{{ $user_info->phone }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                       <select name="blood_group" class="form-control" value="{{ old('blood_group') }}" >
                                                            <option value="">Select Blood Group</option>
                                                            <option value="A+" @if($user_info->blood_group == 'A+') selected @endif>A+</option>
                                                            <option value="A-" @if($user_info->blood_group == 'A-') selected @endif>A-</option>
                                                            <option value="B+" @if($user_info->blood_group == 'B+') selected @endif>B+</option>
                                                            <option value="B-" @if($user_info->blood_group == 'B-') selected @endif>B-</option>
                                                            <option value="O+" @if($user_info->blood_group == 'O+') selected @endif>O+</option>
                                                            <option value="O-" @if($user_info->blood_group == 'O-') selected @endif>O-</option>
                                                            <option value="AB+" @if($user_info->blood_group == 'AB+') selected @endif>AB+</option>
                                                            <option value="AB-" @if($user_info->blood_group == 'AB-') selected @endif>AB-</option>
                                                        </select>
                                                    </div>
                                                </div>
                            ...
                            <form method="POST" action="{{ route('doctor-schedule-update') }}" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                <div class="incs">
                                @if(!$doctor_schedule->isEmpty())
                                    ...
                                    <div class="day-row">
                                     <div class="col-lg-3 col-md-3 col-sm-8 col-xs-7 col-md-offset-1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                <input type="time" value="{{ $doctorSched->start_time }}" name="start_time[]" placeholder="Start Time" class="form-control" data-toggle="tooltip" data-placement="top" title="Start Time" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="time" value="{{ $doctorSched->end_time }}" id="endtime" class="form-control" placeholder="End Time" name="end_time[]" data-toggle="tooltip" data-placement="top" title="End Time" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                <input type="time" name="start_time[]" placeholder="Start Time" class="form-control" data-toggle="tooltip" data-placement="top" title="Start Time" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="time" id="endtime" class="form-control" placeholder="End Time" name="end_time[]" value="" data-toggle="tooltip" data-placement="top" title="End Time" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @endif
                                            ...
                                            <input type="hidden" value="{{ $doctor_info->user_id }}" name="doc_id">
                             ...
                             <div role="tabpanel" class="tab-pane fade" id="degree_with_icon_title">
                                    <form method="POST" action="{{ route('doctor-degree-update') }}" class="form-horizontal">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" value="{{ $doctor_info->user_id }}" name="doctor_id">
                                        <div class="row clearfix">
                                            <div class="inc">
    ...
    oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-8 col-xs-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <select class="form-control" onchange="otherDepartment(event)" required name="department[]" oninvalid="this.setCustomValidity('Please select a department')"
    oninput="this.setCustomValidity('')">
                                                                <option value="">Select Department</option>
                                                                @foreach($department_inf as $department_value)
                                                                <option value="{{ $department_value->name }}">{{ $department_value->name }}</option>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <select class="form-control" id="select2" onchange="otherDepartment(event)" name="degree[]" required oninvalid="this.setCustomValidity('Please select a degree')"
    oninput="this.setCustomValidity('')">
                                                                <option value="">Select Degree</option>
                                                                <optgroup label="Bachelor of Medicine">
    ...
    oninput="this.setCustomValidity('')">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="others_with_icon_title">
                                    <form method="POST" action="{{ route('doctor-personalinfo-update') }}"
    ...
    <script>
        ...
        function deleteSchedule(scdid)
        {
            ...
            if(cnf == true)
            {
                ...
                var targetUrl = baseUrl + '/delete_scheduled/' + scdid;
                // alert(targetUrl);
            ...
            $("#append").click(function(e) {
                ...
                $(".inc").append('<div class="input-row"><div  class="col-lg-3 col-md-3 col-sm-8 col-xs-7 col-md-offset-1 col-lg-offset-1">\
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-8 col-xs-7">\
                                                    <div class="form-group">\
                                                        <div class="form-line">\
                                                        <select class="form-control"  onchange="otherDepartment(event)" name="degree[]" required>\
                                                        <option value="">Select Degree</option>\
                                                        <optgroup label="Bachelor of Medicine">\
                                                            <option value="MBBS">Bachelor of Medicine(MBBS)</option>\
                                                            <option value="BMBS">Bachelor of Medicine(BMBS)</option>\
        ...
        $('a[data-toggle="tab"]').on('show.bs.tab', function (e) {
            localStorage.setItem('activeTabUserEdit', $(e.target).attr('href'));
        });
        var activeTabUserEdit = localStorage.getItem('activeTabUserEdit');
        if (activeTabUserEdit) {           
            $('#useredit_tab a[href="' + activeTabUserEdit + '"]').tab('show');
        }
