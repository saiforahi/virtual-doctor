            ...
            <a href="#" style="text-decoration: none;">
                <div class="info-box bg-teal hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $total_moderators }}" data-speed="1000"
                            data-fresh-interval="20">{{ $total_moderators }}</div>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="#" style="text-decoration: none;">
                <div class="info-box bg-green hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $total_doctors }}" data-speed="1000"
                            data-fresh-interval="20">{{ $total_doctors }}</div>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="#" style="text-decoration: none;">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $dashboard_info['total_patient'] }}"
                            data-speed="15" data-fresh-interval="20">{{ $dashboard_info['total_patient'] }}</div>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="#" style="text-decoration: none;">
                <div class="info-box bg-teal hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Patients</div>
                        <div class="number count-to" data-from="0" data-to="{{ $dashboard_info['total_patient'] }}"
                            data-speed="1000" data-fresh-interval="20">{{ $dashboard_info['total_patient'] }}</div>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="#" style="text-decoration: none;">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $dashboard_info['followup_patient'] }}"
                            data-speed="15" data-fresh-interval="20">{{ $dashboard_info['followup_patient'] }}</div>
                    </div>
                </div>
            </a>
        </div>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <ul class="nav nav-tabs tab-nav-right" role="tablist" id="moderator_tab">
                        ...
                        <li role="presentation"><a id="mod_tab_2" href="#appointment" data-toggle="tab">APPOINTMENTS</a>
                        </li>
                        <li role="presentation"><a id="mod_tab_3" href="#followup_patient" data-toggle="tab">FOLLOWUP
                                PATIENTS</a></li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>Appointment: </span>
                                                        ...
                                                        @elseif($data->isbooked == 1 && $data->isServiced == 0 &&
                                                        $data->isApproved == 0)
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>Symptoms: </span>{{ $data->patient_symptoms }}</td>
                                                    ...
                                                    <td><span>Assigned Doctor: </span>{{ $data->doctors->name }}</td>
                                                    ...
                                                    <td><span>Status: </span>
                                                        ...
                                                        <span class="badge bg-green">Confirmed</span>
                                                                ...
                                                                <span class="badge bg-red">Pending</span>
                                                                        @endif
                                                   <div class="mt-3"><span class="badge bg-red"
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>Investigations: </span>{{ $data->investigation }}</td>
            ...
            <div class="card">
                <div class="body">
                    ...
                    <ul class="nav nav-tabs tab-nav-right" role="tablist" id="doctor_tab">
                        ...
                        <li role="presentation"><a href="#patient" id="doc_tab_2" data-toggle="tab">MY PATIENTS</a></li>
                        <li role="presentation"><a href="#followup_patient" id="doc_tab_3" data-toggle="tab">FOLLOWUP
                                PATIENTS</a></li>
                    </ul>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="colSession"><span>Virtual Session: </span>
                                                        ...
                                                        <b>
                                                        <i class="text-success" id="<?php echo "txtStartSession" . $data->id ?>"></i>
                                                        </b>
                                                    </td>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div style="font-size: 16px; font-weight: bold; margin-bottom: 10px;">
                <strong style="color:red">Related News : </strong><a href="https://corona.gov.bd/"
                    target="_blank">corona.gov.bd</a>, <a href="http://www.iedcr.gov.bd/" target="_blank">IEDCR</a>, <a
                    href="https://www.worldometers.info/coronavirus/" target="_blank">Worldwide Corona Update Today</a>
            </div>
            <div class="card">
                <div class="body">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs tab-nav-right" role="tablist" id="patient_tab">
                        <li role="presentation" class="active"><a href="#book" data-toggle="tab">BOOK APPOINTMENT</a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="book">
                            ...
                            <h5 class="text-success">You have requested for an Appointment. Please Click
                                <strong>'APPOINTMENTS'</strong> from top menu for details</h5>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td><span>Gender:</span>{{ $data->users->gender }}</td> --}}
                                                    <td><span>Symptoms:</span>{{ $data->patient_symptoms }}</td>
                                                    <td><span>Appoint Date:</span>{{ $data->visit_date }} <br>
                                                        <strong
                                                            style="color:blue">{{ date('h:i:s A', strtotime($data->slots->start_time)) }}
                                                    ...
                                                    <strong class="text">N/A<strong>
                                                            ...
                                                            <td class="colAction"><span>Action:</span>
                                                                ...
                                                                <a id="<?php echo "btnCancleApt_pat" . $data->id ?>"
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>Action: </span><a
                                                            href="{{ route('prescription_download',$data->id)}}"
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>Action: </span>
                                                        <a href="{{ route('downloadfile', $data->id) }}" class="btn btn-primary"><i class="material-icons">file_download</i></a>
                                                        <!-- <a
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <ul class="nav nav-tabs tab-nav-right" role="tablist" id="superadmin_tab">
                        ...
                        <li role="presentation"><a id="sup_tab_4" href="#documents" data-toggle="tab">Uploaded Documents</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var role = "";
        role = ('{{ $role }}' == "1"?"super-admin":"other");
       
        if (role=="other" && allApt.length > 0) {
                ...
                if (item.isServiced == 0 && (!(s_status != null) || s_status == 0 || s_status == 2 ||
                    ...
                    setInterval(() => {
                        ...
                        var diff_start = moment.duration(moment(aptTimeStart).diff(moment(
                            currentTime)));
                        var diff_end = moment.duration(moment(currentTime).diff(moment(
                            aptTimeEnd)));
                        ...
                        // console.log("----------item: " + item.id +"  apt date:"+a_milliseconds+" currentDate:"+c_milliseconds);
                        
                    //     console.log("#####item: " + item.id + " s hr: " + diff_start.hours() +
                    //         " s min: " + diff_start.minutes());
                    //same day
                        if (yearDiff == 0 && monthDiff == 0 && dateDiff == 0) {
                            if (diff_start.hours() >= 0 && diff_start.minutes() > 0) {
                                ...
                                var msghr = (diff_start.hours() == 0) ? "" : diff_start
                                    .hours() + " hour(s) ";
                                $('#txtStartSession' + (item.id)).text("Start after " +
                                        msghr + diff_start.minutes() + " minute(s).")
                                    .removeClass("bg-red");
                                ...
                                $('#txtJoinSession' + (item.id)).text("Join after " +
                                        msghr + diff_start.minutes() + " minute(s).")
                                    .removeClass("bg-red");
                                $("#btnCancleApt_pat" + (item.id)).show();
                                $("#btnReschedule_pat" + (item.id)).hide();

                            } else if (diff_start.hours() == 0 && diff_start.minutes() <= 0 &&
                                diff_end.hours() <= 0 && diff_end.minutes() < 0
                            ) { //same day in between session duration 
                                $("#btnStartSession" + (item.id)).show();
                                $('#txtStartSession' + (item.id)).text("").removeClass(
                                "bg-red");
                                $("#txtReplaceCancle" + (item.id)).show();
                                $("#btnReschedule_doc" + (item.id)).hide();
                                ...
                                $("#btnStartSession" + (item.id)).hide();
                                $('#txtStartSession' + (item.id)).text("Appointment Missed !!!")
                                    .addClass("bg-red");
                                $("#btnReschedule_doc" + (item.id)).show();
                                $("#txtReplaceCancle" + (item.id)).hide();
                                //Patient dash
                                $("#btnJoinSession" + (item.id)).hide();
                                $('#txtJoinSession' + (item.id)).text("Appointment Missed !!!")
                                    .addClass("bg-red");
                            ...
                            if((c_milliseconds-a_milliseconds)<0){
                                ...
                                // doc dash
                                $("#btnStartSession" + (item.id)).hide();
                                $('#txtStartSession' + (item.id)).text("Upcoming").removeClass(
                                "bg-red");
                                $("#txtReplaceCancle" + (item.id)).show();
                                $("#btnReschedule_doc" + (item.id)).hide();
                                //Patient dash
                                $("#btnJointSession" + (item.id)).hide();
                                $('#txtJoinSession' + (item.id)).text("Upcoming").removeClass(
                                "bg-red");
                                $("#btnCancleApt_pat" + (item.id)).show();
                                $("#btnReschedule_pat" + (item.id)).hide();
                             }else{
