        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="body">
                                <form method="POST" action="{{ route('slot.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="Time" id="start_time" class="form-control" onchange="timeCheck()" name="start_time" value="" required oninvalid="this.setCustomValidity('Please select start time')"
    oninput="this.setCustomValidity('')">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="time" id="end_time" class="form-control" name="end_time" value=""  onchange="lastTimeCheck()" onkeyup="lastTimeCheck()" required oninvalid="this.setCustomValidity('Please select end time')"
    oninput="this.setCustomValidity('')">
                                                </div>
                                            </div>
                                         </div>
